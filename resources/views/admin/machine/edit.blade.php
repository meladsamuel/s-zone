...
@section('content')
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">update machine data 
                                </li>
                            </ol>
                        </div>
                    </div>
   ...
   @endforeach
@endif
                                        <form class="form" action="{{route('admin.machine.update',$machines ->id)}}" method="POST">
                                            @csrf
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$machines -> name}}" id="name"
                                                                   class="form-control"
